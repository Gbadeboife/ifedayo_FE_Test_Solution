...
export default function EditPropertyRulesModal({ modalOpen, closeModal, rules }) {
      ...
      >
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex z-10 min-h-full items-center justify-center p-4 text-center">
              <Transition.Child
                as={Fragment}
                enter="ease-out duration-300"
              ...
              >
                ...
                >
                  ...
                  <textarea
                    ...
                    defaultValue={spaceData?.rule ? spaceData?.rule : rules}
                  ></textarea>
