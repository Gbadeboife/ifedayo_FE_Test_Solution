...
export default function EditPropertyNameModal({ modalOpen, closeModal, name }) {
  ...
  async function onSubmit(e) {
    ...
    dispatch({ type: "SET_PROPERTY_NAME", payload: name });
    closeModal();
  }
                ...
                >
                 <Dialog.Title
                  ...
                  <textarea
                    ...
                    defaultValue={spaceData?.name ? spaceData?.name : name}
                  ></textarea>
