...
export default function CustomerReviewsPage() {
  ...
  async function getData(pageNum, pageSize) {
    ...
    const where = [`ergo_review.customer_id = ${user_id}`, `ergo_review.given_by = ${type == 1 ? "'customer'" : "'host'"}`];
    try {
  ...
  return (
    <div className="eighteen-step-summary pt-[44px] min-h-screen">
                      ...
                      return (
                        ...
                        >
                          <span className="flex items-center gap-2">
                            <StarIcon />
                            {(Number(type == 0 ? row.customer_rating : row.space_rating) || 0).toFixed(1)}
                          </span>
                        </td>
                      );
                    }
                    ...
                    if (cell.accessor == "host_full_name") {
                      return (
                        <td
                          ...
                          className="px-6 py-4 whitespace-nowrap"
                        >
                          {row[`host_first_name`] + " " + row[`host_last_name`]}
                        </td>
                      );
                    }
                    if (cell.mapping) {
            ...
            <div className="flex gap-6 mb-[24px]">
              {[1, 2, 3, 4, 5].map((val) => (
                <svg
                  ...
                  height="18"
                  viewBox="0 0 18 18"
                  fill={(type == 1 ? viewReviewData.space_rating : viewReviewData.customer_rating) >= val ? "#FEC84B" : "none"}
                ...
                >
                  <path
                    ...
                    stroke={(type == 1 ? viewReviewData.space_rating : viewReviewData.customer_rating) >= val ? "#FEC84B" : "#98A2B3"}
                  />
                </svg>
              ))}
            </div>
