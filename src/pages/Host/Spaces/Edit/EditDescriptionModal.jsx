...
export default function EditDescriptionModal({ modalOpen, closeModal, propertyDescription }) {
  const { state, dispatch } = useSpaceContext();
              ...
              >
                ...
                >
                  ...
                  <textarea
                    ...
                    defaultValue={state?.description ? state?.description : propertyDescription}
                  ></textarea>
